...
// +kubebuilder:rbac:groups=applicationautoscaling.services.k8s.aws,resources=scheduledactions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=applicationautoscaling.services.k8s.aws,resources=scheduledactions/status,verbs=get;update;patch
