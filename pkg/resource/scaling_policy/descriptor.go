...
const (
	finalizerString = "finalizers.applicationautoscaling.services.k8s.aws/ScalingPolicy"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("scalingpolicies")
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.ScalingPolicy{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ScalingPolicy),
	}
}
