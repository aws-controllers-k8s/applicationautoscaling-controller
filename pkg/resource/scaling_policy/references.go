...
// identifier field.
func validateReferenceFields(ko *svcapitypes.ScalingPolicy) error {
...
func (rm *resourceManager) resolveReferenceForResourceID(
	...
	if ko.Spec.ResourceRef != nil && ko.Spec.ResourceRef.From != nil {
		...
		obj := &svcapitypes.ScalableTarget{}
		if err := getReferencedResourceState_ScalableTarget(ctx, apiReader, obj, *arr.Name, namespace); err != nil {
			return hasReferences, err
		}
		ko.Spec.ResourceID = (*string)(obj.Spec.ResourceID)
	}

	return hasReferences, nil
}

// getReferencedResourceState_ScalableTarget looks up whether a referenced resource
// exists and is in a ACK.ResourceSynced=True state. If the referenced resource does exist and is
// in a Synced state, returns nil, otherwise returns `ackerr.ResourceReferenceTerminalFor` or
// `ResourceReferenceNotSyncedFor` depending on if the resource is in a Terminal state.
func getReferencedResourceState_ScalableTarget(
	ctx context.Context,
	apiReader client.Reader,
	obj *svcapitypes.ScalableTarget,
