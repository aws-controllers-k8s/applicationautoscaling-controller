...
func (rm *resourceManager) sdkCreate(
	...
	_, respErr := rm.sdkapi.RegisterScalableTargetWithContext(ctx, input)
	rm.metrics.RecordAPICall("CREATE", "RegisterScalableTarget", respErr)
	if respErr != nil {
		return nil, respErr
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkDelete(
	...
	_, respErr := rm.sdkapi.DeregisterScalableTargetWithContext(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "DeregisterScalableTarget", respErr)
	return respErr
}
