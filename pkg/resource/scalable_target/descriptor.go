...
const (
	FinalizerString = "finalizers.applicationautoscaling.services.k8s.aws/ScalableTarget"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("scalabletargets")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ScalableTarget{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ScalableTarget),
	}
}
